...
func TestStudyPackageBuilderCreatesDataAndRealManifest(t *testing.T) {
	...
	for _, relative := range []string{
		filepath.Join("windows", "Symphony Viewer.exe"),
		filepath.Join("macos", "Symphony Viewer.app", "Contents", "Info.plist"),
		filepath.Join("macos", "Symphony Viewer.app", "Contents", "MacOS", "Symphony Viewer"),
	} {
